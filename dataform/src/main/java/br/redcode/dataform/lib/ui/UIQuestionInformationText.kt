 ...
 */
class UIQuestionInformationText(question: Question, settings: QuestionSettings) : UIQuestionBase(R.layout.ui_question_informative_text, question, settings), Questionable {
