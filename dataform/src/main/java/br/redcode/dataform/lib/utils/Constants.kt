package br.redcode.dataform.lib.utils
...
object Constants {
    ...
    const val SUFFIX_QUESTION_TEXTVIEW = "_textview"
    const val SUFFIX_QUESTION_EDITTEXT = "_edittext"
    const val SUFFIX_QUESTION_RECYCLERVIEW = "_recyclerview"
    const val SUFFIX_QUESTION_SPINNER = "_spinner"
    const val SUFFIX_QUESTION_SEEKBAR = "_seekbar"
