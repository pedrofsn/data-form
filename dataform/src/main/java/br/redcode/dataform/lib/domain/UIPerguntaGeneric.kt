 ...
 */
abstract class UIPerguntaGeneric(val context: Context, val idLayout: Int, val question: Question, val configuracao: QuestionSettings) : Questionable {
    ...
    override fun getMessageInformation(): String {
        val messageDefaultLimits = question.limit?.getMessageDefault(context)
