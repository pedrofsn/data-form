 ...
 */
class UIPerguntaMultiplaEscolha(contextActivity: Context, val pergunta: Pergunta) : UIPerguntaGeneric<Pergunta>(contextActivity, pergunta, R.layout.ui_pergunta_objetiva), Perguntavel, OnItemClickListener {
